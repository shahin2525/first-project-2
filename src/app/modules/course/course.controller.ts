...
// facultyWithCourse
const createFacultyWithCourse: RequestHandler = catchAsync(async (req, res) => {
  const { courseId } = req.params
  const data = req.body
  const result = await CourseServices.updateCourseIntoDB(courseId, data)
  sendResponse(res, {
    statusCode: httpStatus.OK,
    success: true,
